const easyIncidents = [
  ...
  },
  {
    ...
    question:
      "You find a USB drive in the office parking lot. What is the safest action?",
  ...
  },
  {
    ...
    question:
      "You receive a verification code (OTP) on your phone that you didn't request. What should you do?",
  ...
  },
  {
    ...
    question:
      "You need to check your online banking while using free airport Wi-Fi. What is the safest choice?",
  ...
  },
  {
    ...
    question:
      "A website says you won a new phone and asks for your credit card details. What should you do?",
  ...
  },
  {
    ...
    question:
      "You leave your desk for lunch. What should you do before leaving?",
  ...
  },
  {
    ...
    question:
      "Your laptop asks you to install a security update. What should you do?",
  ...
  },
  {
    ...
    question:
      "A stranger emails you an attachment called 'Invoice.zip'. What should you do?",
  ...
  },
  {
    ...
    question:
      "A flashlight app asks for permission to access your contacts and microphone. What should you do?",
  ...
  },
  {
    ...
    question:
      "Your friend asks to borrow your streaming account password. What is the safest habit?",
  ...
  },
  {
    ...
    question:
      "Your browser says 'Connection Not Secure' before you enter your password. What should you do?",
  ...
  },
  {
    ...
    question:
      "You see a QR code stuck on an ATM with no explanation. What should you do?",
  ...
  },
  {
    ...
    question:
      "You receive a message from an unknown person asking you to click a link. What should you do?",
  ...
  },
  {
    ...
    question:
      "You realize your work laptop is missing. What should you do first?",
  ...
  },
  {
    ...
    question:
      "Someone emails you pretending to be IT support and asks for your password. What should you do?",
  ...
  },
  {
    ...
    question:
      "Your phone receives a Bluetooth pairing request from an unknown device. What should you do?",
  ...
  },
  {
    ...
    question:
      "An email offers you a job with a very high salary but asks for your passport and bank details first. What should you do?",
...
const mediumIncidents = [
  {
    ...
    question:
      "The system detects 25 failed login attempts on an employee's account within two minutes. What should you do first?",
  ...
  },
  {
    ...
    question:
      "An employee successfully logs in from Bahrain and then from the UK five minutes later. What is the best first action?",
  ...
  },
  {
    ...
    question:
      "An employee reports clicking a suspicious email link but entered no credentials. What should you do first?",
  ...
  },
  {
    ...
    question:
      "A user downloads an unknown '.exe' file from the internet. What is your first response?",
  ...
  },
  {
    ...
    question:
      "Security software detects that an unknown USB device was connected to a company laptop. What should you do first?",
  ...
  },
  {
    ...
    question:
      "A workstation reports that antivirus protection has been disabled unexpectedly. What should you do?",
  ...
  },
  {
    ...
    question:
      "A user uploads several gigabytes of company files to a personal cloud storage account. What is the best first response?",
  ...
  },
  {
    ...
    question:
      "An employee reports receiving a notification that someone logged into their account from another country. What should you do first?",
  ...
  },
  {
    ...
    question:
      "The company's homepage has suddenly been replaced with unauthorized content. What should you do first?",
  ...
  },
  {
    ...
    question:
      "The firewall detects repeated login attempts from the same external IP address. What should you do?",
  ...
  },
  {
    ...
    question:
      "Network monitoring detects a workstation communicating with an unknown external server. What is your first action?",
  ...
  },
  {
    ...
    question:
      "You discover two employees are using the same account to access company systems. What should you do?",
  ...
  },
  {
    ...
    question:
      "A normal employee account suddenly receives administrator privileges. What should you do first?",
  ...
  },
  {
    ...
    question:
      "A critical vulnerability has been announced for your company's operating system. What should you do?",
  ...
  },
  {
    ...
    question:
      "Several employees report receiving the same suspicious attachment. What should you do first?",
  ...
  },
  {
    ...
    question:
      "An employee who normally works in HR accesses confidential Finance documents. What should you do?",
  ...
  },
  {
    ...
    question:
      "An employee reports losing their company phone. What should you do first?",
  ...
  },
  {
    ...
    question:
      "A user disables Multi-Factor Authentication on their account without approval. What should you do?",
  ...
  },
  {
    ...
    question:
      "A user account logs into the company network at 3:00 AM, which is unusual for that employee. What should you do?",
  ...
  },
  {
    ...
    question:
      "Endpoint security software reports malware on a user's computer. What is your first action?",
